...
<div class="max-w-2xl mx-auto">
    ...
    <div class="card">
        <form action="{{ route('staff.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="color" value="{{ old('color', '#C9907A') }}"
            ...
            <x-weekly-schedule field-name="working_hours" label="Working Hours" :hours="[]" :limits="$salonHours ?? null" />

            @if(auth()->user()->isSuperAdmin() && $salons->isNotEmpty())
            <div class="col-span-2">
                <label class="section-label block mb-1.5">Assign to Salon</label>
